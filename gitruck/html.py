...
class Html:
    ...
    def add_logo(self):
        ...
        self.body += (
            ...
            f'<img src="./{self._images_path}{image_ID}.png" width="250" height="250" alt="gitruck_logo">\n'
            "</p>"
        )
    ...
    def _get_logo(self):
        response = requests.get(
            "https://github.com/bereis01/gitruck/blob/main/assets/gitruck_logo.png?raw=true"
        )
